								...
								return (
									...
									>
										...
										<div className="w-2.5 shrink-0 flex justify-center">
											{hasUnread(email) && (
												<div className="h-2.5 w-2.5 rounded-full bg-kumo-brand" />
											)}
										</div>
										...
										<div className="min-w-0 flex-1">
											<div className="flex items-center gap-2">
												...
												{(email.thread_count ?? 1) > 1 && (
													<span className="shrink-0 text-[10px] bg-kumo-brand/10 text-kumo-brand rounded-full px-1.5 py-0.5 font-bold">
														{email.thread_count}
													</span>
												)}
												{email.has_draft && (
